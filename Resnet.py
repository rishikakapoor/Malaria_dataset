{
  ...
  "metadata": {
    "colab": {
      ...
      "provenance": [],
      "collapsed_sections": [],
      "authorship_tag": "ABX9TyMNSdhtacRuTxQAlVIN72cC",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/rishikakapoor/Malaria_dataset/blob/master/Resnet.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      "metadata": {
        "id": "1ZcsipUqAxQj",
        "colab_type": "code",
        "outputId": "f927dd58-e421-4a55-f737-af83debcd727",
        "colab": {
    ...
    },
    {
      ...
      "metadata": {
        "id": "mU9M9fjpEEI6",
        "colab_type": "code",
        "outputId": "661e184d-496e-4fda-8fe3-cd779c630a7f",
        "colab": {
          "base_uri": "https://localhost:8080/",
          "height": 34
        }
    ...
    },
    {
      ...
      "metadata": {
        "id": "4y6XrAZREHjJ",
        "colab_type": "code",
        "outputId": "5430c981-12da-4ad9-ea4c-12d6e6b9e19d",
        "colab": {
          "base_uri": "https://localhost:8080/",
          "height": 204
        }
      ...
      "outputs": [
        {
          ...
          "data": {
            "text/html": [
              ...
              "    <tr>\n",
              "      <th>0</th>\n",
              "      <td>/content/Malaria_dataset/Malaria_dataset/Paras...</td>\n",
              "      <td>malaria</td>\n",
              "    </tr>\n",
              "    <tr>\n",
              "      <th>1</th>\n",
              "      <td>/content/Malaria_dataset/Malaria_dataset/Uninf...</td>\n",
              "      <td>healthy</td>\n",
              "    </tr>\n",
              "    <tr>\n",
              "      <th>2</th>\n",
    ...
    },
    {
      ...
      "metadata": {
        "id": "Cyh2_H2iEJwI",
        "colab_type": "code",
        "outputId": "72ad07d1-fca6-496b-c47f-7d4882e309bf",
        "colab": {
          "base_uri": "https://localhost:8080/",
          "height": 85
        }
    ...
    },
    {
      ...
      "metadata": {
        "id": "m_CPqdvkENFm",
        "colab_type": "code",
        "outputId": "9763a14c-2a98-4cb1-9aa9-9caa04e5bd7f",
        "colab": {
          "base_uri": "https://localhost:8080/",
          "height": 187
        }
    ...
    },
    {
      ...
      "metadata": {
        "id": "LXXqq7r8EX7A",
        "colab_type": "code",
        "outputId": "cc2d63ff-8961-4f99-c281-7003ae601359",
        "colab": {
          "base_uri": "https://localhost:8080/",
          "height": 289
        }
    ...
    },
    {
      ...
      "metadata": {
        "id": "rh-kxYxBEbbb",
        "colab_type": "code",
        "outputId": "d1ec09d2-2ae9-4b0e-8068-b919ef8efe10",
        "colab": {
          "base_uri": "https://localhost:8080/",
          "height": 34
        }
    ...
    },
    {
      ...
      "metadata": {
        "id": "GOy-vCA2onvE",
        "colab_type": "code",
        "outputId": "46b2b22c-d3c5-48b2-ffed-bec0fb077b15",
        "colab": {
          "base_uri": "https://localhost:8080/",
          "height": 1000
        }
    ...
    },
    {
      ...
      "metadata": {
        "id": "ZUkMqTPoonyL",
        "colab_type": "code",
        "outputId": "de7a76fa-ba82-4212-e401-9be3b583afae",
        "colab": {
          "base_uri": "https://localhost:8080/",
          "height": 68
        }
      ...
      "outputs": [
        {
          ...
          "text": [
            ...
            "Epoch 1/5\n",
            "17344/17360 [============================>.] - ETA: 0s - loss: 0.3402 - acc: 0.8650"
          ],
          "name": "stdout"
        }
      ]
    ...
    },
    {
      ...
      "metadata": {
        "id": "dHL4Riycon55",
        "colab_type": "code",
        "outputId": "dba6bf67-e5d4-4d6d-d13e-19aff2d78419",
        "colab": {
          "base_uri": "https://localhost:8080/",
          "height": 306
        }
      ...
      "outputs": [
        {
          ...
          "text": [
            ...
            "Requirement already satisfied: keras>=2.0 in /usr/local/lib/python3.6/dist-packages (from resnet) (2.2.5)\n",
            ...
            "Requirement already satisfied: numpy>=1.9.1 in /usr/local/lib/python3.6/dist-packages (from keras>=2.0->resnet) (1.17.5)\n",
            "Requirement already satisfied: scipy>=0.14 in /usr/local/lib/python3.6/dist-packages (from keras>=2.0->resnet) (1.4.1)\n",
            "Requirement already satisfied: keras-preprocessing>=1.1.0 in /usr/local/lib/python3.6/dist-packages (from keras>=2.0->resnet) (1.1.0)\n",
            "Requirement already satisfied: h5py in /usr/local/lib/python3.6/dist-packages (from keras>=2.0->resnet) (2.8.0)\n",
            "Requirement already satisfied: keras-applications>=1.0.8 in /usr/local/lib/python3.6/dist-packages (from keras>=2.0->resnet) (1.0.8)\n",
